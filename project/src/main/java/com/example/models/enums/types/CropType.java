...
public enum CropType {
    ...
    SUNFLOWER("Sunflower", "Sunflower Seeds", 1, 2, 3, 2, -1, 8, true, -1, 80, true, 45, new Season[]{Season.SUMMER, Season.AUTUMN}, false),
    TOMATO("Tomato", "Tomato Seeds", 2, 2, 2, 2, 3, 11, false, 4, 60, true, 20, new Season[]{Season.SUMMER}, false),
    WHEAT("Wheat", "Wheat Seeds", 1, 1, 1, 1, -1, 4, true, -1, 25, false, 0, new Season[]{Season.SUMMER, Season.AUTUMN}, false),
    AMARANTH("Amaranth", "Amaranth Seeds", 1, 2, 2, 2, -1, 7, true, -1, 150, true, 50, new Season[]{Season.AUTUMN}, false),
    ARTICHOKE("Artichoke", "Artichoke Seeds", 2, 2, 1, 2, 1, 8, true, -1, 160, true, 30, new Season[]{Season.AUTUMN}, false),
    BEET("Beet", "Beet Seeds", 1, 1, 2, 2, -1, 6, true, -1, 100, true, 30, new Season[]{Season.AUTUMN}, false),
    BOK_CHOY("Bok Choy", "Bok Choy Seeds", 1, 1, 1, 1, -1, 4, true, -1, 80, true, 25, new Season[]{Season.AUTUMN}, false),
    BROCCOLI("Broccoli", "Broccoli Seeds", 2, 2, 2, 2, -1, 8, false, 4, 70, true, 63, new Season[]{Season.AUTUMN}, false),
    CRANBERRIES("Cranberries", "Cranberry Seeds", 1, 2, 1, 1, 2, 7, false, 5, 75, true, 38, new Season[]{Season.AUTUMN}, false),
    EGGPLANT("Eggplant", "Eggplant Seeds", 1, 1, 1, 1, -1, 5, false, 5, 60, true, 20, new Season[]{Season.AUTUMN}, false),
    FAIRY_ROSE("Fairy Rose", "Fairy Seeds", 1, 4, 4, 3, -1, 12, true, -1, 290, true, 45, new Season[]{Season.AUTUMN}, false),
    GRAPE("Grape", "Grape Starter", 1, 1, 2, 3, 3, 10, false, 3, 80, true, 38, new Season[]{Season.AUTUMN}, false),
    PUMPKIN("Pumpkin", "Pumpkin Seeds", 1, 2, 3, 4, 3, 13, true, -1, 320, false, 0, new Season[]{Season.AUTUMN}, true),
    YAM("Yam", "Yam Seeds", 1, 3, 3, 3, -1, 10, true, -1, 160, true, 45, new Season[]{Season.AUTUMN}, false),
    SWEET_GEM_BERRY("Sweet Gem Berry", "Rare Seed", 2, 4, 6, 6, 6, 24, true, -1, 3000, false, 0, new Season[]{Season.AUTUMN}, false),
    POWDER_MELON("Powder Melon", "Powdermelon Seeds", 1, 2, 1, 2, 1, 7, true, -1, 60, true, 63, new Season[]{Season.WINTER}, true),
    ANCIENT_FRUIT("Ancient Fruit", "Ancient Seeds", 2, 7, 7, 7, 5, 28, false, 7, 550, false, 0, new Season[]{Season.AUTUMN, Season.SUMMER, Season.SPRING}, false),
    ;
