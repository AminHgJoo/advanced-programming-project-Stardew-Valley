...
public enum PierreProducts implements StoreProductInterface {
    ...
    GRASS_STARTER("Grass Starter", "Place this on your farm to start a new patch of grass.", MiscType.GRASS_STARTER, 100, 100, Double.POSITIVE_INFINITY, Season.values()),
