...
public enum CraftingRecipes implements Recipe {
    ...
    CHARCOAL_KLIN("Charcoal Klin", "Converts 10 wood to 1 coal.", 1, 0, 0, 0, 0, new ArrayList<>()),
    FURNACE("Furnace", "Convert ores and coal into ingots.", 0, 0, 0, 0, 0, new ArrayList<>()),
    SCARE_CROW("Scare Crow", "Prevents crow attacks in an 8 tile radius.", 0, 0, 0, 0, 0, new ArrayList<>()),
    DELUXE_SCARE_CROW("Deluxe Scarecrow", "Prevents crow attacks in a 12 tile radius.", 2, 0, 0, 0, 0, new ArrayList<>()),
    BEE_HOUSE("Bee House", "Produces honey.", 1, 0, 0, 0, 0, new ArrayList<>()),
    CHEESE_PRESS("Cheese Press", "Produces cheese from milk.", 2, 0, 0, 0, 0, new ArrayList<>()),
    KEG("Keg", "Ferments fruits and vegetables into drinks.", 3, 0, 0, 0, 0, new ArrayList<>()),
    LOOM("Loom", "Processes wool.", 3, 0, 0, 0, 0, new ArrayList<>()),
    MAYONNAISE_MACHINE("Mayonnaise Machine", "Produces mayonnaise from eggs.", 0, 0, 0, 0, 0, new ArrayList<>()),
    OIL_MAKER("Oil Maker", "Produces oil from truffles.", 3, 0, 0, 0, 0, new ArrayList<>()),
