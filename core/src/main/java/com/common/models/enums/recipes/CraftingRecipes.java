package com.common.models.enums.recipes;
...
public enum CraftingRecipes {
    CHERRY_BOMB("Cherry Bomb", "Destroys everything in a 3 tile radius.", 0, 1, 0, 0, 50,
            new Slot[]{new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.COPPER_ORE), 4), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.COAL), 1)},
            MiscType.CHERRY_BOMB),
    BOMB("Bomb", "Destroys everything in a 5 tile radius.", 0, 2, 0, 0, 50,
            new Slot[]{new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.IRON_ORE), 4), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.COAL), 1)},
            MiscType.BOMB),
    MEGA_BOMB("Mega Bomb", "Destroys everything in a 7 tile radius.", 0, 3, 0, 0, 50,
            new Slot[]{new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.GOLD_ORE), 4), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.COAL), 1)},
            MiscType.MEGA_BOMB),
    ...
    FURNACE("Furnace", "Convert ores and coal into ingots.", 0, 0, 0, 0, 0,
            new Slot[]{new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.STONE), 25), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.COPPER_ORE), 20)},
            MiscType.FURNACE),
    SCARE_CROW("Scare Crow", "Prevents crow attacks in an 8 tile radius.", 0, 0, 0, 0, 0,
            new Slot[]{new Slot(new Misc(MiscType.FIBER), 20), new Slot(new Misc(MiscType.WOOD), 50), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.COAL), 1)},
            MiscType.SCARE_CROW),
    DELUXE_SCARE_CROW("Deluxe Scarecrow", "Prevents crow attacks in a 12 tile radius.", 2, 0, 0, 0, 0,
            new Slot[]{new Slot(new Misc(MiscType.FIBER), 20), new Slot(new Misc(MiscType.WOOD), 50), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.COAL), 1), new Slot(new Misc(MiscType.IRIDIUM_BAR), 1)},
            MiscType.DELUXE_SCARE_CROW),
    BEE_HOUSE("Bee House", "Produces honey.", 1, 0, 0, 0, 0,
            new Slot[]{new Slot(new Misc(MiscType.IRON_BAR), 1), new Slot(new Misc(MiscType.WOOD), 40), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.COAL), 8)},
            MiscType.BEE_HOUSE),
    CHEESE_PRESS("Cheese Press", "Produces cheese from milk.", 2, 0, 0, 0, 0,
            new Slot[]{new Slot(new Misc(MiscType.COPPER_BAR), 1), new Slot(new Misc(MiscType.WOOD), 45), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.STONE), 45)},
    ...
    MAYONNAISE_MACHINE("Mayonnaise Machine", "Produces mayonnaise from eggs.", 0, 0, 0, 0, 0,
            new Slot[]{new Slot(new Misc(MiscType.COPPER_BAR), 1), new Slot(new Misc(MiscType.WOOD), 15), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.STONE), 15)},
    ...
    PRESERVES_JAR("Preserves Jar", "Produces jam from fruits and vegetables.", 2, 0, 0, 0, 0,
            new Slot[]{new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.COAL), 8), new Slot(new Misc(MiscType.WOOD), 50), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.STONE), 40)},
    ...
    DEHYDRATOR("Dehydrator", "Dries fruits and mushrooms.", Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 0,
            new Slot[]{new Slot(new Misc(MiscType.FIBER), 30), new Slot(new Misc(MiscType.WOOD), 30), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.STONE), 20)},
            MiscType.DEHYDRATOR),
    FISH_SMOKER("Fish Smoker", "Smokes fish while preserving their quality.", Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 0,
            new Slot[]{new Slot(new Misc(MiscType.IRON_BAR), 3), new Slot(new Misc(MiscType.WOOD), 50), new Slot(new ForagingMineralItem(Quality.DEFAULT, ForagingMineralsType.COAL), 10)},
